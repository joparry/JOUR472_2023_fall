...
Jain Ashwani Friends of is the committee that donated the most to Facebook.
...
Media_expenses_clean <- read.csv('data/Media_expenses.clean.csv')
...
**A2. Jain Ashwani Friends of was the committee name for a guy that ran for the Governor of Maryland. The committee named Franchot Anderson--Walker for Maryland Slate became running mates for Prince George's councilmember. King and Siri are the ticket of a candidate and his running mate for Maryland goevrnor, and Siri advocates for women's rights.**

All of the big ads are currently inactive, and have an audience of over one million people.
...
**A3. Wes Moore and Aruna Miller are missing from the list as well as Dan Cox and Gordana Schifanelli, Tom Perez and Sharron Sneed, and Kelly Schulz and Jeff Woolford. Wes Moore's campaign did run ads on Facebook, Dan Cox did run ads, Tom Perez and Kelly Schulz did run ads as well. SKDK and Foglamp are the biggest recipients of media expenses.**
...
**A4. This new list is a lot different from the one about the top Facebook spenders in Q1. Franchot Anderson--Walker for Maryland Slate did spend all fo their online advertising dollars on Facebook.**
...
**A5 We do know how much each candidate spent on facebook through multiple committees, what we don't know is how many committees were used by each candidate to spread the wealth around. I think the best story idea I have found here is that Franchot Anderson--Walker's committee for Maryland Slate spent all of its advertising money on Facebook ads.**
