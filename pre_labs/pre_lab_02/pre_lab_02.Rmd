...
**Answer It is important that a new variable was created because before we could only limit variables to one topic, and now they can hold a lot more information making data easier for us to find.**
...
**Answer Or chooses one of the things either the department or the seats, and the and operator brings them together.**
...
**Answer: The date is flipped, with the year being at the start of the date instead of the month.**
...
**Answer I don't really know what is going on here but I think that the mutate function is being used to get the higest value present in each month and sort them that way.**
...
**Answer I think that the code is putting Moore's total vote number into a mutated collumn with the votes from all of the candidates.**
...
**Answer The anser changed from the previous task because now, the percentage of Moore's votes are being arrange from highest percentage he had in a county to the lowest percentage he had in a county.**
...
**Answer I think that this is a more interesting answer becauyse of the makeup of the state. Because Maryland has been leaning blue recently, it's interesting to see the parts of the state that go the opposite in as big way just in order to have that data.**
...
**Answer The first function I have is str_to_lowercase which converts everthign to lowercase. The second function I have is str_to_sentence, which covnerts everything to sentence case.**
...
**Answer The mutate statement is going through each state listed and creating a column for the expenses associated with each individual state listed in order.**
...
**Answer This answer does make sense to me because it is arranging the state expenses in order from highest to lowest based on the state.**
...
1.  How much more do Maryland spend on expenses to dates with a higher population than those with less people?

2.  What is the state that Maryland has given the least amount of money to?

3.  What percent of Journalism classes have more than 30 people in them?
