...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer The first step under is mutating the month column to make it the date and makes it an expression rather than a character. It then groups the table by month, before ordering the calls in each month to be calculated and then orders them from biggest number to smallest number of calls.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer I see a blank grey space on the screen.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer After running the code below, I see a bar chart on the screen which is of the calls sorted by month.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer The months instead of being in chronological order are now sorted in ascending order on the chart.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer The chart is now faced sideways, and it is in descending order from the top down, with the x axis of labels on the left hand side of the chart.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer The background behind the bars in the bar chart is now white instead of being light grey.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer The background behind the whole chart is now light blue, with white lines behind. The months and numbers on the axis are now both in a darker color font and are larger in font.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer There is now a big and bold header on top of the bar chart, both of the label names on either axis have now been shortened and changed, and a reference to the source of the data is located in the bottom right hand corner of the chart.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer What I see is a record of the Baltimore County 911 calls on each day starting from February 6th in 2022, and going through January of 2023.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer What I see is a very congested line graph of the Baltimore 911 call data.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer What I see is the same chart, but with the x axis completely messed up and the timing of the points on the graph not clear.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer I see the same thing, but with the x axis being a little bit easier to read now as opposed to before.**
