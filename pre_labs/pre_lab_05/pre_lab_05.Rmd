...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer Maryland's data is the header for this data set.**
...
**Task** Load the data without headers by running the codeblock below. What problems remain? The headers are just numbers, so you don't actually know what any of the data means.
...
**Task** Run the codeblock below. What else do we need to do? **Answer The format of the jurisdiction column still doesn't look very clean.**
