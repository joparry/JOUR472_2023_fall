...
**Task** Load the four CSV population estimate files. Do they have the same column structure? **Answer** Yes they do all have the same column structure.
...
**Task** Combine the four files into a single data frame using the bind_rows function. Add a description of what this code does to your reference notebook. This code combines all of the data into one table, and adds one column which is an extra total tab on the right hand side.
...
**Task** Run the following code to filter on Frederick County's registration data and look at the results. What stands out to you about the changes in party registration over time? **Answer** Unaffiliated rises significantly, and other also rises significantly, and there is a big jump in population as well. Democrats have a bigger increase than the Republicans.
...
It contains the population that is of a certain race or ethnicity and the population that is over the age of 18 years old. Also includes population that is of two certain races.
...
**Task** Using mutate, let's find the county with the highest 18+ Black population as a percentage of all population 18 and over and also the percentage of Democrats in that county. Put your answers below. **Answer The county with the highest black population perecentage over 18 years old is Prince George's County with 60.9%. The percentage of Democrats in the county is 77.09%.**
...
**Task** Now let's find the county with the highest 18+ Asian population as a percentage of all population 18 and over and also the percentage of Democrats in that county. How do these results compare to the previous task? Put your answers below. **Answer The county with the highest percentage of Asians over 18 years old is Howard County with 19.3%. The percentage of democrats in Howard County is 52.57%. These results are a lot smaller than the previous task, and the percentage of democrats is a lot lower in the county with the highest percentage of voting age Asians than it is in the county with the highest percentage of voting age Black people.**
...
**Task** Run the following code to load the Zip Code Tabulation Area data for Maryland. What's the datatype of the ZCTA5N column? **Answer The data type for the ZCTA5N column is \<dbl\>.**
...
**Task** Run the following code to change the datatype of ZCTA5N from numeric to character. What's the datatype of ZCTA5N? The new data type of ZCTA5N is a \<chr\>.
